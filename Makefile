...
test-php-71: dcdown make-integration-workers-accessible
	...
	docker-compose exec -T php71 php $(PHP_OPTIONS) vendor/bin/phpunit7.phar -c build/phpunit7.xml ${PHPUNIT_OPTIONS}
.PHONY: test-php-71
...
test-php-72: dcdown make-integration-workers-accessible
	...
	docker-compose exec -T php72 php $(PHP_OPTIONS) vendor/bin/phpunit8.phar -c build/phpunit8.xml ${PHPUNIT_OPTIONS}
.PHONY: test-php-72
...
test-php-73: dcdown make-integration-workers-accessible
	...
	docker-compose exec -T php73 php $(PHP_OPTIONS) vendor/bin/phpunit9.phar -c build/phpunit9.xml ${PHPUNIT_OPTIONS}
.PHONY: test-php-73
...
test-php-74: dcdown make-integration-workers-accessible
	...
	docker-compose exec -T php74 php $(PHP_OPTIONS) vendor/bin/phpunit9.phar -c build/phpunit9.xml ${PHPUNIT_OPTIONS}
.PHONY: test-php-74
...
test-php-80: dcdown make-integration-workers-accessible
	...
	docker-compose exec -T php80 php $(PHP_OPTIONS) vendor/bin/phpunit9.phar -c build/phpunit9.xml ${PHPUNIT_OPTIONS}
.PHONY: test-php-80
